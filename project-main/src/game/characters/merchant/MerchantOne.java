 ...
 */
public class MerchantOne extends Actor implements MerchantNPC {
     ...
     */
    public MerchantOne() {
        super("Moore the Gravesite Plains Merchant", '$', 0);
    ...
    @Override
    public String greet() {
        return this.name + ": 'Greetings, tarnished one. Behold, the wares I offer.' ";
    }
    ...
    public Boolean outofsale() {
        if ( this.inventory.isEmpty() ){
            System.out.println( this.name + ": 'Alas, it seems I have nothing left to peddle.' ");
            return true;
        }
        return false;
    }
